...
Data..............: 12/02/2025
Observações.......: Estudo e análise sobre a utilização das variáveis
'''

numero = 23          # Variável do tipo inteiro
nota = 19.56         # Variável do tipo real
nome = "Ana Jorge"   # Variável do tipo string
...
print(f"O resultado entre {numero} + 56 = {resultado}")

print(nome + "Silva") # Concatenação